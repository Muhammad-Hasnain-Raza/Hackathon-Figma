  ...
  return (
    <main className="w-full h-full md:h-[500px] flex flex-col md:flex-row justify-between items-start bg-[#F2F0F1]">
        ...
        <div className="relative">
          <Image src={"/rectangle2.png"} alt={"backgraound"} width={200} height={200} className="w-[500px] h-[500px] mr-4"/>
          <Image src={"/star.png"} alt={"star"} width={200} height={200} className="w-[50px] md:w-[100px] absolute top-[100px] left-10 md:top-[300px] md:left-[-100px] "/>
          <Image src={"/star.png"} alt={"star"} width={200} height={200} className="w-[60px] md:w-[100px] absolute top-[10px] right-[50px] md:top-[50px] md:right-[30px] "/>
        </div>
    </main>
  )
}
