  ...
  return (
    <div className="font-sans">
      <section className="my-10">
        <h2 className="text-2xl font-bold mb-6 px-4 lg:px-0 lg:leading-tight lg:whitespace-nowrap lg:text-left text-center lg:m-20">
          <span className="block lg:inline">OUR HAPPY CUSTOMERS</span>
        </h2>
