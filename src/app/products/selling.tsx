    ...
    <div className="w-[full] h-[500px] mt-10">
      ...
      <div className="mt-10">
        ...
        <div className="flex lg:hidden overflow-x-auto space-x-4 px-4 scrollbar-hide">
          {product.map((data) => (
            <div
              ...
              className="flex-shrink-0 w-[230px] h-auto bg-[#F0EEED] rounded-[20px]"
            >
        ...
        <div className="hidden lg:flex justify-between px-8">
          {product.map((data) => (
            <div key={data.id}> {/* Unique key for each product */}
        ...
        <div className="flex justify-center mt-6">
          <button className="border rounded-[16px] w-[218px] h-[42px] border-gray-500">
            View All
          </button>
        </div>
      </div>
